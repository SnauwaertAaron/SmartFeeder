...
const getWater = function() {
  handleData(`http://${lanIP}/water`,showWater);
};

const getVoeding = function() {
  handleData(`http://${lanIP}/voeding`,showVoeding);
};

const getPortie = function() {
  handleData(`http://${lanIP}/portie`,showPortie);
};

const getPorties = function() {
  handleData(`http://${lanIP}/porties`,showPorties);
};

const getVoedermomenten = function() {
  handleData(`http://${lanIP}/voedermomenten`,showVoedermomenten);
};
