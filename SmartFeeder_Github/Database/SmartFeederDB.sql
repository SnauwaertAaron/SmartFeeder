CREATE DATABASE  IF NOT EXISTS `smartfeederdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `smartfeederdb`;
...
CREATE TABLE `feeders` (
  ...
  `Feedernaam` varchar(45) NOT NULL,
  `Bijnaam` varchar(45) DEFAULT NULL,
...
CREATE TABLE `sensoren` (
  ...
  `Meetapparaat` varchar(75) NOT NULL,
...
-- Dump completed on 2020-05-24 17:09:00
